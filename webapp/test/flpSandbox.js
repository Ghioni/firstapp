		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "First App",
									"targetURL": "#createfirstapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"createfirstapp-display": {
								"semanticObject": "createfirstapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=create.firstapp",
									"url": sap.ui.require.toUrl("create/firstapp")
								}
							}
						}
					}
